...
require_once 'TDProject/Statistic/ImplementationTest.php';
 ...
 */
class TDProject_Statistic_AllTests
{
    ...
    public static function suite()
    {
        ...
        // add a test
        $suite->addTestSuite('TDProject_Statistic_ImplementationTest');
